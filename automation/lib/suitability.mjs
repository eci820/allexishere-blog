// 블로그 적합도 판단(v2.5): 각 키워드에 별점(★1~5)·한 줄 이유·위험 경고를 붙인다.
...
const INFO =
  /방법|뜻|의미|기준|일정|얼마|언제|어떻게|왜|신청|조회|자격|요건|조건|계산|비교|후기|추천|가격|요금|비용|연납|환급|신고|납부|접종|예방|권장량|식단|증상|효능|정리|총정리|가이드|순위|목록|리스트|기간|마감|혜택|지원금|보조금|사용법|설정/;
