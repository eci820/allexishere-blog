...
// 연도 토큰(2024~2028·'년')은 갱신글 제목·설명 곳곳에 들어가 무관한 글끼리 동점을
// 만들어 진짜 관련글을 밀어내므로 제외한다(캘린더 노이즈).
const STOPWORDS = new Set([
  '총정리', '정리', '방법', '이유', '원인', '전망', '가이드', '기준', '절차',
  '오늘', '최신', '공개', '총', '및', '관련', '주요', '핵심', '무엇', '어떻게',
  '위한', '대한', '있는', '하는', '되는', '그리고', '하지만', '이란', '입니다',
  // 연도 노이즈: '(2026)'은 '2026'으로, '2026년'은 숫자+년이 한 토큰으로 남으므로
  // 두 형태를 모두 제외한다.
  '2024', '2025', '2026', '2027', '2028', '년',
